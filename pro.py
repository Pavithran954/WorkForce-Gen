...
def visualization_and_text_gen():
    ...
    #     st.download_button("Download Report (Word)", "\n".join(st.session_state.report_content), mime="application/vnd.openxmlformats-officedocument.wordprocessingml.document")
    #     st.download_button("Download Report (PDF)", "\n".join(st.session_state.report_content), mime="application/pdf")
